...
public class HomeBase : ComponentBase
{
    ...
    public MemoryStream? GetImemFile() => imemFileMemoryStream;
    public MemoryStream? GetCsvFile() => csvFileMemoryStream;

    protected void OnChange(byte[] fileContent, string fileName)
    {
