...
public class HomeBase : ComponentBase
{
    ...
    protected bool File3Uploaded { get; set; } = false;

    protected DateTime? Date1 { get; set; }

    protected DateTime? Date2 { get; set; }

    // Propriété calculée pour Date3, qui renvoie toujours la dernière date du mois de Date2
    ...
    // Options pour sélectionner le fichier à uploader
    protected List<dynamic> FileOptions = new List<dynamic>
    {
        new { Text = "CSV #1", Value = 1 },
        new { Text = "CSV #2", Value = 2 },
        new { Text = "CSV #3", Value = 3 }
    };

    protected int SelectedFileToUpload { get; set; }
    ...
    protected void OnChange(byte[] value, string name)
    {
